...
func (t *Client) GetOSSAndSecret(c *gin.Context, ossConfig *OssConfig, credentials Credentials) {
	...
	t.AccessKey = credentials.AccessKeyId
	t.SecretKey = credentials.AccessKeySecret
