...
func TestMyTimeline(t *testing.T) {
	...
	t.Run("MyTimeline with no filters", func(t *testing.T) {
		timelineMedia, err := actions.MyTimeline(user, nil, nil, nil)
	...
	t.Run("MyTimeline with only favorites", func(t *testing.T) {
		favorites := true
		timelineMedia, err := actions.MyTimeline(user, nil, &favorites, nil)
	...
	t.Run("MyTimeline before date", func(t *testing.T) {
		...
		timelineMedia, err := actions.MyTimeline(user, nil, nil, &beforeDate)
